...
class RequestCommentCard extends StatefulWidget {
  ...
  @override
  State<RequestCommentCard> createState() => _RequestCommentCardState();
}

class _RequestCommentCardState extends State<RequestCommentCard> {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  ...List.generate(widget.comment.replies.take(takeSize).length, (index) => RequestCommentCard(
